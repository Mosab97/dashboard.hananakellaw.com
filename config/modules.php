...
return [
    ...
    'working-day' => [
        'table' => 'working_days',
        'route' => 'working-day',
        'full_route_name' => 'working-day',
        'singular_name' => 'Working Day',
        'plural_name' => 'Working Days',
        'singular_key' => 'working_day',
        'plural_key' => 'working_days',
        'view_path' => 'CP.working_days.',
        'id_field' => 'id',
        'controller' => \App\Http\Controllers\CP\WorkingDayController::class,
        'permissions' => [
            'view' => 'view_working_days',
            'create' => 'create_working_days',
            'edit' => 'edit_working_days',
            'delete' => 'delete_working_days',
        ],
    ],
