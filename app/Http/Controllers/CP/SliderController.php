...
use App\Http\Requests\CP\SliderRequest;
use App\Models\Slider;
use App\Services\Filters\SliderFilterService;
...
class SliderController extends Controller
{
    ...
    public function __construct(
        Slider $_model,
        SliderFilterService $filterService,
    ) {
        $this->config = config('modules.sliders');
        $this->_model = $_model;
    ...
    public function edit(Request $request, Slider $_model)
    {
    ...
    public function addedit(SliderRequest $request)
    {
        ...
        try {
            ...
            // dd($validatedData);
            if ($imageFile) {
                $imagePath = Storage::disk('public')->putFile('sliders', $imageFile);
    ...
    public function delete(Request $request, Slider $_model)
    {
        try {
            DB::beginTransaction();
