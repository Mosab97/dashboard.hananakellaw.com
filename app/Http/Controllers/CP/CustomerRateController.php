...
use App\Http\Requests\CP\CustomerRateRequest;
use App\Models\CustomerRate;
use App\Services\Filters\CustomerRateFilterService;
...
class CustomerRateController extends Controller
{
    ...
    public function __construct(
        CustomerRate $_model,
        CustomerRateFilterService $filterService,
    ) {
        $this->config = config('modules.customer_rates');
        $this->_model = $_model;
    ...
    public function edit(Request $request, CustomerRate $_model)
    {
    ...
    public function addedit(CustomerRateRequest $request)
    {
    ...
    public function delete(Request $request, CustomerRate $_model)
    {
        try {
            DB::beginTransaction();
