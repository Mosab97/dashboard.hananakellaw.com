...
use App\Http\Requests\CP\HowWeWorkRequest;
use App\Models\HowWeWork;
use App\Services\Filters\HowWeWorkFilterService;
...
class HowWeWorkController extends Controller
{
    ...
    public function __construct(
        HowWeWork $_model,
        HowWeWorkFilterService $filterService,
    ) {
        $this->config = config('modules.how_we_works');
        $this->_model = $_model;
    ...
    public function edit(Request $request, HowWeWork $_model)
    {
    ...
    public function addedit(HowWeWorkRequest $request)
    {
    ...
    public function delete(Request $request, HowWeWork $_model)
    {
        try {
            DB::beginTransaction();
