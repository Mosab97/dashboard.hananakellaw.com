...
use App\Http\Requests\CP\SizeRequest;
...
class SizeController extends Controller
{
    ...
    public function __construct(
        ...
        $this->config = config('modules.restaurants.children.sizes');
        $this->_model = $_model;
    ...
    public function index(Request $request)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            return DataTables::eloquent($items)
                ...
                ->editColumn('restaurant_name', function ($item) {
                    return optional($item->restaurant)->name ?? 'N/A';
                })
                ...
                ->rawColumns(['size_name', 'price', 'status', 'action'])
                ->make(true);
        }
    }
    ...
    public function edit(Request $request, Size $_model)
    {
    ...
    public function details(Request $request, Size $_model)
    {
    ...
    public function addedit(SizeRequest $request)
    {
    ...
    public function delete(Request $request, Size $_model)
    {
        try {
            DB::beginTransaction();
