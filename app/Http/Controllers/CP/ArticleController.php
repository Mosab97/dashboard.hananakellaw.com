...
use App\Http\Requests\CP\ArticleRequest;
use App\Models\Article;
use App\Models\ArticleType;
use App\Services\Filters\ArticleFilterService;
...
class ArticleController extends Controller
{
    ...
    public function __construct(
        ...
        $this->config = config('modules.articles');
        $this->_model = $_model;
    ...
    public function edit(Request $request, Article $_model)
    {
    ...
    public function addedit(ArticleRequest $request)
    {
    ...
    public function delete(Request $request, Article $_model)
    {
        try {
            DB::beginTransaction();
    ...
    protected function getCommonData($action = null)
    {
        ...
        if (in_array($action, ['create', 'edit'])) {
            $data['article_type_list'] = ArticleType::all();
        }
