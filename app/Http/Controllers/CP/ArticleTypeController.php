...
use App\Http\Requests\CP\ArticleTypeRequest;
use App\Models\ArticleType;
use App\Services\Filters\ArticleTypeFilterService;
...
class ArticleTypeController extends Controller
{
    ...
    public function __construct(
        ArticleType $_model,
        ArticleTypeFilterService $filterService,
    ) {
        $this->config = config('modules.articles_types');
        $this->_model = $_model;
    ...
    public function edit(Request $request, ArticleType $_model)
    {
    ...
    public function addedit(ArticleTypeRequest $request)
    {
    ...
    public function delete(Request $request, ArticleType $_model)
    {
        try {
            DB::beginTransaction();
