...
class CustomerRateRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'description.he' => ['nullable', 'string', 'max:500'],
    ...
    public function messages()
    {
        return [
            ...
            'description.he.string' => t('English description must be a string'),
            'description.ar.string' => t('Arabic description must be a string'),
            'description.*.max' => t('Description must not exceed 500 characters'),
