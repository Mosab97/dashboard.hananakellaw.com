    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-body p-9">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="fv-row mb-7">
                        <label class="fw-semibold fs-6 mb-2">{{ t('Rate') }}</label>
                        <input type="number" name="rate" class="form-control form-control-solid mb-3 mb-lg-0 validate-required @error("rate") is-invalid @enderror"
                            placeholder="{{ t('Enter Rate') }}"
                            value="{{ old("rate", isset($_model) ? $_model->rate : '') }}" />
                        @error("rate")
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
