            ...
            <div class="row">
             <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="time" name="start_time" class="form-control" value="{{ old('start_time', $_model->exists ? $_model->start_time->format('H:i') : '') }}"
                            required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="time" name="end_time" class="form-control" value="{{ old('end_time', $_model->exists ? $_model->end_time->format('H:i') : '') }}"
                            required>
                    </div>
                </div>
            </div>
